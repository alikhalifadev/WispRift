...
#[derive(Debug)]
pub struct WispRiftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WispRiftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WispRift processing");
    
    let mut processor = WispRiftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WispRiftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WispRiftProcessor::new(false);
